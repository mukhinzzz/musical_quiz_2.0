  ...
  },
  {
    ...
    tasks: [
      ...
      },
      {
        ...
        played: false,
        question: {
          text: "Назовите продукт, который Саша разлюбила пару лет назад и который теперь появляется на нашем столе только для гостей (я его тоже не люблю). Сегодня на нашем столе он тоже присутствует",
        },
        answer: {
